#!/usr/bin/env python3
"""Validate Shadowfetch Linux 3.5.0 packages and signed APT repository."""
...
EXPECTED_BINARIES = {
    "grub-btrfs": "4.14-2",
    "shadowfetch-branding": "3.5.0-1",
    "shadowfetch-control-center": "3.5.0-1",
    "shadowfetch-creative-base": "3.5.0-1",
    "shadowfetch-defaults": "3.5.0-1",
    "shadowfetch-desktop": "3.5.0-1",
    "shadowfetch-ember": "3.5.0-1",
    "shadowfetch-fireproof": "3.5.0-1",
    "shadowfetch-fireline": "3.5.0-1",
    "shadowfetch-firewatchd": "3.5.0-1",
    "shadowfetch-hwscan": "3.5.0-1",
    "shadowfetch-menus": "3.5.0-1",
    "shadowfetch-nvidia": "3.5.0-1",
    "shadowfetch-phoenix": "3.5.0-1",
    "shadowfetch-themes": "3.5.0-1",
    "shadowfetch-welcome": "3.5.0-1",
}
EXPECTED_SOURCES = {
    "grub-btrfs",
...
def payload_gate(package_paths: dict[str, Path], extracted: Path) -> None:
    ...
    if [profile.get("id") for profile in profiles] != [
        ...
        raise RuntimeError("Element Workbench profile allowlist differs from 3.5.0")
    ...
    if 'VERSION = "3.5.0"' not in ignition or 'SERVER_VERSION = "3.5.0"' not in mcp:
        raise RuntimeError("Fireline protocol surfaces are not stamped for 3.5.0")
    ...
    print("PASS: Fireline and AI Ignition 3.5.0 Buzz ownership contract")
